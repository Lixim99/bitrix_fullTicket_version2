...
$arResult['DETAIL_PICTURE_PATH'] = $arResult['DETAIL_PICTURE']['SRC'];
$this->getComponent()->setResultCacheKeys(array('DETAIL_PICTURE_PATH'));

$arResult['PREVIEW_TEXT_FOR_HEAD'] = substr(trim($arResult['PREVIEW_TEXT']),3,44) . '...';
$this->getComponent()->setResultCacheKeys(array('PREVIEW_TEXT_FOR_HEAD'));
?>